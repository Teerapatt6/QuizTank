...
const favouriteModel = {
     ...
     */
    getUserFavourites: async (userId, limit = 20, offset = 0, sortBy = 'newest', category = 'all', searchQuery = '', difficulty = 'all') => {
        ...
        let whereClause = 'WHERE gf.user_id = $1 AND gf.status = 1 AND gr.status = 1 AND gr.visibility IN (1, 3, 4)';
