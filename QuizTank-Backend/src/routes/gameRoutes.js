...
router.get('/recent', optionalAuth, landingPageController.getRecentGames);
router.get('/trending', optionalAuth, landingPageController.getTrendingGames);
router.get('/popular-ai', optionalAuth, landingPageController.getPopularAiGames);
router.get('/search', landingPageController.searchGames);
router.post('/contact', landingPageController.submitContact);
