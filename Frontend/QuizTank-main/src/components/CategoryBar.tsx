        ...
        <div className="flex justify-start md:justify-center gap-2 sm:gap-4 md:gap-8 overflow-x-auto pb-2 md:pb-0 scrollbar-hide">
          {categories.map((category) => (
            <button
              ...
              className={`flex flex-col items-center gap-1.5 md:gap-2 p-2 md:p-3 rounded-xl transition-all duration-200 hover:bg-secondary group shrink-0 ${selectedCategory === category.id ? 'bg-secondary' : ''
                }`}
            >
