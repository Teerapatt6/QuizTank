    ...
    const fetchGame = async () => {
      ...
      try {
        ...
        const diffResult = calculateDifficulty({
          ...
          enemies: data.enemies || 8,
          duration: data.duration || 8,
          hearts: data.hearts || 3,
          brains: data.brains || 8,
          initial_ammo: data.initial_ammo || 50,
          ammo_per_correct: data.ammo_per_correct || 5
        });
        ...
        setGame({
          ...
          tags: data.tags || [],
          imageUrl: data.cover_image || coverImg,
          status: data.status,
        ...
        setGameSettings([
          ...
          { label: "Allowed Mistakes", value: `${data.brains !== undefined ? data.brains : 1} brains`, icon: Brain, color: "bg-blue-50 border-blue-100" },
                ...
                <div className="flex-1">
                  ...
                  <div className="flex items-center justify-between gap-4 mb-3">
                    ...
                    <div className="flex items-center gap-2.5">
                      ...
                      {game.visibility === 3 && (
                        <Lock className="w-5 h-5 text-gray-700 mb-0.5" />
                      )}

                      <h1 className="text-lg lg:text-xl font-extrabold text-gray-900 tracking-tight leading-tight line-clamp-2 truncate max-w-[400px]">
                        {game.title}
                      </h1>
                    </div>
                    ...
                    {/* Rating */}
                    <div className="flex items-center gap-1.5 bg-yellow-50 text-yellow-700 px-3 py-1 rounded-full border border-yellow-100 font-bold shadow-sm">
                  ...
                  >
                    ...
                    <span className="font-semibold text-gray-900 group-hover/creator:text-primary transition-colors">{game.creator}</span>
                  </div>

                  <div className="flex items-center gap-2.5 mb-5">

                    <Badge variant="outline" className={`${getDifficultyColor(game.difficulty)} px-3 py-1`}>
                      {game.difficulty}
                    </Badge>

                    {game.isAiGenerated && (
                      <Badge variant="outline" className="bg-violet-100 border-violet-200 text-violet-600 px-3 py-1">
                        AI Generated
                      </Badge>
                    )}
                  ...
                  <div className="flex flex-wrap gap-3">
                    ...
                    {game.tags.length > 0 && game.tags.map(tag => (
                      <span
                        key={tag}
                        className="text-blue-500 hover:underline cursor-pointer text-sm font-medium transition-colors"
              ...
              <CardContent className="p-6 pt-4">
                ...
                >
                  <button
                    ...
                    className={`px-6 py-3 font-medium text-sm transition-all duration-200 border-b-2 -mb-px ${activeInfoTab === 'gameplay'
                  ...
                  <button
                    ...
                    className={`px-6 py-3 font-medium text-sm transition-all duration-200 border-b-2 -mb-px ${activeInfoTab === 'leaderboard'
                      ? 'text-[#007BFF] border-[#007BFF] font-semibold'
                      : 'text-gray-500 border-transparent hover:text-gray-700 hover:border-gray-300'
                      }`}
                  >
                  ...
                  {user && (
                    <>
                      <button
                        ...
                        className={`px-6 py-3 font-medium text-sm transition-all duration-200 border-b-2 -mb-px ${activeInfoTab === 'history'
                          ? 'text-[#007BFF] border-[#007BFF] font-semibold'
                          : 'text-gray-500 border-transparent hover:text-gray-700 hover:border-gray-300'
                          }`}
                      >
                      ...
                      {user.username !== game.creatorUsername && (
                        <button
                          ...
                          className={`px-6 py-3 font-medium text-sm transition-all duration-200 border-b-2 -mb-px ${activeInfoTab === 'review'
                            ? 'text-[#007BFF] border-[#007BFF] font-semibold'
                            : 'text-gray-500 border-transparent hover:text-gray-700 hover:border-gray-300'
                            }`}
                        >
                ...
                {activeInfoTab === 'gameplay' && (
                  ...
                  >
                    <div className="flex items-start justify-between mb-3">
                      ...
                      <span className="text-xs text-gray-500">Created: {game.createdAt ? format(new Date(game.createdAt), "d MMM yyyy") : ""}</span>
                    </div>
                    <p className="text-sm text-gray-600 leading-relaxed mb-6">{game.description}</p>
                              ...
                              >
                                ...
                                <div>
                                  ...
                                  <div className="flex items-center gap-0">
                                    ...
                                    <p className="text-xs text-gray-500">{entry.playedAt}</p>
                                  </div>
                                </div>
                              </div>
                              <div className="text-xl font-bold text-blue-600">{entry.time}</div>
                            </div>
                          )
                        )}
                      </div>
                        ...
                        {playHistory.map((play) => (
                          ...
                          >
                            <div className="flex items-center gap-4">
                              ...
                              <div>
                                <div className="flex items-center gap-2.5 mb-1">
                                  ...
                                  {play.isBest && (
                                    <Badge variant="outline" className="bg-yellow-500 text-white font-semibold border-0 gap-1 px-2 py-0.5">
                                      <Star className="w-3 h-3 fill-white" /> Best Played
                                    </Badge>
                                  )}
                                </div>
                            ...
                            <div className="flex items-center gap-2 text-gray-600 font-medium">
                              <Timer className="w-4 h-4 text-gray-400 mb-1" />
            ...
            <Card className="shadow-lg border-gray-100 sticky top-24">
              <CardContent className="p-6">
                ...
                <Button
                  ...
                  variant="default"
                  size="lg"
                  className="w-full font-bold text-lg h-14 shadow-md mb-6"
                >
                  ...
                  <CardContent className="p-4">
                    <div className="flex items-center gap-3 mb-4">
                      ...
                      <div>
                        ...
                        {user?.username === game.creatorUsername ? (
                          <p className="text-sm font-semibold text-gray-500">No XP for playing your own game</p>
                        ) : user && playHistory.some(p => p.status === 2) ? (
                          <p className="text-sm font-semibold text-teal-600">Earned {game.xp} XP from this game</p>
                        ) : (
                          <p className="text-sm font-semibold text-gray-500">Play this game to earn {game.xp} XP</p>
                        )}
                      </div>
                    </div>
                        ...
                        {user ? (
                          <>
                            <div className="flex items-center justify-between mb-2">
                              <span className="font-semibold text-gray-900">Level {Math.floor(userXP / 1000) + 1}</span>
                          ...
                          <div className="text-center py-2 text-sm text-muted-foreground bg-muted rounded-md px-2 py-3">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
            {relatedGames.map((relatedGame) => {
              const gameStats = {
                ...
                enemies: relatedGame.enemies || 5,
                duration: Number(relatedGame.duration) || 10,
                hearts: relatedGame.hearts || 3,
                brains: relatedGame.brains || 3,
                initial_ammo: relatedGame.initial_ammo || 50,
                ammo_per_correct: relatedGame.ammo_per_correct || 5
              };
            ...
            <>
              ...
              <div className="flex justify-center gap-2 pt-4 pb-2">
                {(game.gameCode || '000000').split('').map((char, index) => (
                  <div
                    key={index}
                    className="w-12 h-14 flex items-center justify-center text-2xl font-bold rounded-xl border-2 border-primary text-primary bg-primary/5 shadow-sm uppercase font-mono"
                  >
                    {char}
                  </div>
                ))}
              ...
              <div className="flex items-center gap-3 mt-2">
                ...
                <Button variant="normal" onClick={handleNativeShare} className="w-full gap-2" size="default">
