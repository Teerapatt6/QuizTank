                ...
                <div className="p-8 flex flex-col gap-8 relative z-10">
                  ...
                  <div className="flex items-center justify-center gap-8">
                    ...
                    <div className="relative">
                      <div className="w-48 h-48 rounded-full flex items-center justify-center relative bg-background">
                  ...
                  <div className="md:col-span-2 space-y-2">
                    ...
                    <div className="flex flex-wrap gap-2">
                      {game.tags.map((tag: string) => (
                        <Badge key={tag} variant="secondary" className="px-3 py-1 bg-muted hover:bg-muted/80 text-xs">{tag}</Badge>
                      ))}
                    </div>
                  </div>
                  <div className="md:col-span-2 space-y-2">
                ...
                {game.knowledges.map((knowledge: any, index: number) => (
                  <Card key={knowledge.id} className="p-0 overflow-hidden hover:bg-muted/5 transition-colors">
                    <div className="flex flex-col md:flex-row">
                      ...
                      <div className="w-full md:w-64 bg-muted/30 border-l flex flex-col items-center justify-center p-0 gap-2 text-center relative overflow-hidden h-40 md:h-auto">
              ...
              <div>
                ...
                <Card className="overflow-hidden border-0 shadow-lg">
                  <div className="relative h-64 w-full bg-slate-900 group">
                    {/* Artistic Map Preview */}
                    <div className="absolute inset-0 bg-gradient-to-t from-slate-900 via-transparent to-slate-900/50 z-10" />

                    {/* Abstract grid for map vibe */}
                    <div className="absolute inset-0 opacity-20" style={{
                      backgroundImage: 'radial-gradient(circle, rgba(255,255,255,0.1) 1px, transparent 1px)',
                      backgroundSize: '20px 20px'
                    }}></div>

                    <div className="absolute inset-0 flex items-center justify-center z-20 flex-col gap-2 transition-transform duration-500 group-hover:scale-105">
                      <MapIcon className="w-16 h-16 text-white/80" />
                      <div className="text-3xl font-bold text-white tracking-widest uppercase">{game.gameplay.mapName}</div>
                      <Badge variant="secondary" className="mt-2 bg-white/20 text-white hover:bg-white/30 backdrop-blur-sm border-0">
                        Professional Map
                      </Badge>
                    </div>
                  </div>
          ...
          {game.status === 2 ? (
            ...
            <>
              ...
              <div className="flex items-center gap-3 mt-2">
                ...
                <Button variant="outline" onClick={handleNativeShare} className="w-full gap-2" size="default">
