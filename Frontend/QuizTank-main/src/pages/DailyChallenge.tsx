          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-10">
            ...
            <Card className="shadow-neumorphic border-blue-200 bg-blue-50">
              <CardContent className="p-4 flex items-center justify-between">
                ...
                <span className="text-xl font-bold text-primary">{getTimeUntilReset()}</span>
              </CardContent>
            </Card>
            ...
            <Card className="shadow-neumorphic border-teal-200 bg-teal-50">
              <CardContent className="p-4 flex items-center justify-between">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="font-semibold text-foreground mb-1">Total Active Challenges</p>
                    <p className="text-sm text-muted-foreground">Complete All Challenges to Earn {totalXpEarned} XP</p>
                  </div>
                </div>
                <span className="text-xl font-bold text-teal-500">{getActiveChallengesCount()} Challenges</span>
              </CardContent>
            </Card>
          </div>
        )}
