...
import { Wrench, Sparkles, ChevronLeft, ChevronRight, Plus, Trash2, X, Check, ChevronUp, ChevronDown } from "lucide-react";
                        ...
                        >
                          ...
                          <div className="flex items-center justify-between px-4 py-2 border-b border-border">
                            ...
                            >
                              ...
                              {choice.isCorrect ? "Answer" : "Mark as answer"}
                            </button>
                          </div>
...
- Three Knowledge Boxes containing key concepts students need to answer the questions.`}
  ...
  const handleCreateGame = async (asDraft: boolean = false) => {
    try {
      ...
      if (formData.gameplay.duration > 10) {
        toast.error("Duration must be less than or equal to 10 minutes");
        return;
      }
      ...
      if (formData.gameplay.hearts > 100) {
        toast.error("Hearts must be less than or equal to 100");
        return;
      }
      ...
      if (formData.gameplay.brains > 100) {
        toast.error("Brains must be less than or equal to 100");
        return;
      }
      ...
      if (formData.gameplay.initialAmmo > 100) {
        toast.error("Initial Ammo must be less than or equal to 100");
        return;
      }
      ...
      if (formData.gameplay.ammoPerCorrect > 100) {
        toast.error("Ammo per Correct Answer must be less than or equal to 100");
        return;
      }
