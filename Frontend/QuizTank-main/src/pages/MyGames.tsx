      ...
      <main className="container mx-auto px-4 pt-8 pb-20">
        ...
        <div className="flex justify-between items-center mb-8 animate-fade-in">
          <div>
            ...
            <p className="text-muted-foreground">Manage and track your created games</p>
          </div>
                  ...
                  <div className="flex-1 items-start justify-between mb-3">
                    <div>
                      <div className="flex items-center justify-between mb-2">
                        <h3 className="text-xl font-bold text-foreground truncate max-w-[700px]">{game.name}</h3>
                      ...
                      <div className="flex items-center gap-1 text-sm text-muted-foreground">
                        ...
                        <p>{game.questionCount || 0}{" "}{(game.questionCount || 0) === 1 ? "Question" : "Questions"}</p>
                        <Dot className="w-4 h-4" />
                        <p>{game.knowledgeCount || 0}{" "}{(game.knowledgeCount || 0) === 1 ? "Knowledge" : "Knowledges"}</p>
                        <Dot className="w-4 h-4" />
                        <p>245 Players</p>
                      </div>
                    </div>
          ...
          <div className="flex justify-center mt-10 animate-fade-in">
            <nav className="flex items-center gap-1" aria-label="Pagination">
              ...
              <button
                ...
                className={`flex items-center justify-center w-10 h-10 rounded-lg transition-all ${currentPage === 1
              ...
              {getPageNumbers().map((page, index) => (
                page === "..." ? (
                  ...
                  <button
                    ...
                    className={`flex items-center justify-center w-10 h-10 rounded-lg font-medium transition-all ${currentPage === page
              ...
              <button
                ...
                className={`flex items-center justify-center w-10 h-10 rounded-lg transition-all ${currentPage === totalPages
                  ? "text-muted-foreground/40 cursor-not-allowed"
                  : "text-muted-foreground hover:bg-muted hover:text-foreground"
                  }`}
      ...
      <AlertDialog open={deleteDialogOpen} onOpenChange={setDeleteDialogOpen}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              Are you sure you want to delete "{selectedGame?.name}"? This action cannot be undone and all game data will be permanently removed.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
      ...
      <AlertDialog open={publishDialogOpen} onOpenChange={setPublishDialogOpen}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              Are you sure you want to publish "{gameToPublish?.name}"? Once published, the game will be visible to players and some editing features will be locked.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
            <AlertDialogCancel>Cancel</AlertDialogCancel>
